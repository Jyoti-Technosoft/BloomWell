                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        value={Array.isArray(editForm.specialization) ? (editForm.specialization as string[]).join(', ') : ('')}
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-900">
                        {Array.isArray(profile.specialization) ? (profile.specialization as string[]).join(', ') : ('Not specified')}
                      </p>
                    </div>
