              ...
              >
                ...
                <div className="p-6 pt-2 flex flex-col flex-1">
                  ...
                  <div className="flex gap-2 mt-auto">
                    {doctor.consultationLink && (
                      <button
                        onClick={() => window.open(doctor.consultationLink, '_blank')}
                        className="flex-1 flex items-center justify-center px-3 py-2 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-200"
                      >
                    ...
                    <Link
                      ...
                      className={`${doctor.consultationLink ? 'flex-1' : 'w-full'} flex items-center justify-center px-3 py-2 bg-linear-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-70 hover:to-purple-700 transition-colors duration-200`}
                    >
