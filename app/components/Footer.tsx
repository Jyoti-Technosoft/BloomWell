...
const footerLinks = {
  ...
  contact: [
    { name: 'Email: support@bloomwell.com', href: 'mailto:support@bloomwell.com' },
    { name: 'Phone: 1-800-BLOOM', href: 'tel:1800256669' },
  ],
};
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Personalized weight loss medication and wellness treatments made accessible and affordable. 
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} BloomWell. All rights reserved.
            </div>
          ...
          <div className="mt-6 text-center text-gray-400 text-xs">
            <p>
              Medical services provided by licensed healthcare professionals. 
              Results may vary. Please consult with a healthcare provider to determine if our treatments are right for you.
            </p>
          </div>
        </motion.div>
      </div>
